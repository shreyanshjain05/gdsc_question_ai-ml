...
"""
#TASK  CONVERSION INTO LOWER CASE
#for conversion the given paragraph we can use a functionality in python called .lower()
# CODE:
lower_text=text.lower()
print(lower_text)
#this will give me the entire paragraph in lowercase as output